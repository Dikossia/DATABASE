...
In this laboratory work I learned how SQL transactions help keep a database safe,
correct, and reliable when many operations happen at the same time.
I understood the ACID properties and how each of them protects the data:
atomicity ensures that all steps of a process are completed together,
consistency keeps the database in a valid state, isolation prevents problems
during concurrent access, and durability guarantees that committed changes are not lost.

I also learned how to use the main transaction commands — BEGIN, COMMIT, ROLLBACK, and SAVEPOINT —
